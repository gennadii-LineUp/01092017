...
import {CustServicesVirementsMultiplesPageComponent} from './customer/menu-user/cust-services-page/items/cust-services-virements-multiples-page.component';
import {CustServicesPaiementsPageComponent} from './customer/menu-user/cust-services-page/items/cust-services-paiements.component';
...
@NgModule({
    declarations: [
        ...
        CustServicesConsultationSoldePageComponent,
        CustServicesTransferComptePageComponent, CustServicesTransferDargentPageComponent, CustServicesVirementsMultiplesPageComponent,
        CustServicesPaiementsPageComponent, CServicesTransferDargentPageComponent, CServicesTransferComptePageComponent, CServicesConsultationSoldePageComponent,
