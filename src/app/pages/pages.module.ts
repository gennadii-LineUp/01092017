...
@NgModule({
    ...
    exports: [
        ...
        CustServicesPageComponent, CustServicesBankToWalletPageComponent, CustServicesConsultationOperationsPageComponent,
        CustServicesConsultationSoldePageComponent,
        CustServicesTransferComptePageComponent, CustServicesTransferDargentPageComponent, CustServicesVirementsMultiplesPageComponent, CustServicesPaiementsPageComponent,
